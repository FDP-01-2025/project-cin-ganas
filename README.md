...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **Variables y tipos de datos**                   | Se utilizan variables para almacenar y controlar los distintos atributos de la mascota.                                                                                                                                                 | ![Variables y tipos de datos](./readme-assets/1.png)                   |
| **Estructuras condicionales (if, else, switch)** | Permiten tomar decisiones en el juego, como verificar si la mascota ha muerto o seleccionar opciones del menú.                                                                                                                          | ![Estructuras condicionales (if, else, switch)](./readme-assets/2.png) |
| **Ciclos (for, while, do while)**                | Se utilizaron para facilitar la repetición de procesos, por ejemplo, durante la validación de entradas de datos.                                                                                                                        | ![Ciclos (for, while, do while)](./readme-assets/3.png)                |
| **Funciones**                                    | Se utilizaron para modularizar el proyecto, separando funcionalidades como jugar, dormir, ver estadísticas, etc.                                                                                                                        | ![Funciones](./readme-assets/4.png)                                    |
| **Estructuras de datos**                         | Se utilizó el `struct` para la estructura de datos de la mascota, pues la mascota representa una colección de datos de diferentes tipos: el tipo y el nombre de la mascota (string), la diversión, hambre y energía (int), entre otras. | ![Estructuras de datos](./readme-assets/5.png)                         |
| **Manejo de archivos**                           | Se usó para guardar y recuperar el progreso del juego mediante la escritura y lectura de un archivo `.txt`.                                                                                                                             | ![Manejo de archivos](./readme-assets/6.png)                           |
