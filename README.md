...
| **Estructuras de datos**                         | Se utilizo el struct para la estructura de dato de la mascota, pues la mascota representa una colección de datos de diferentes tipos: el tipo y el nombre de la mascota (string), la diversión, hambre, y energía (int), entre otras. | ![Estructuras de datos](./readme-assets/5.png)                         |
